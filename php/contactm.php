...
$sql="SELECT contactus.name,contactus.email,contactus.hotel,contactus.purpose FROM contactus,manager WHERE contactus.hotel=manager.email AND manager.email='".$_SESSION['email']."'";
