...
$sql="SELECT spa.name,spa.email,spa.phone,spa.gender,spa.hotel,spa.date,spa.time FROM spa,manager WHERE spa.hotel=manager.hotel AND manager.hotel='".$_SESSION['hotel']."'";
